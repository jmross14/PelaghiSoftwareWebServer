package com.pelaghisoftware.server.response.messages;
...
public class ErrorMessage
{
    ...
    /**
     * Get an ErrorMessage object for a failed authentication attempt
     * @return ErrorMessage
     */
    public static ErrorMessage unauthorized()
    {
        return new ErrorMessage("Authentication invalid.");
    }

    /**
     * Get an ErrorMessage object for a bad username/password
     * @return ErrorMessage
     */
    public static ErrorMessage usernamePasswordIncorrect()
    {
        return new ErrorMessage("Username/Password is incorrect.");
    }
}